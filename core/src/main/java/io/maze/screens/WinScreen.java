...
public class WinScreen implements Screen{
     ...
     *                   access the score
     */
    public WinScreen(final Main game, final GameScreen gameScreen){
        this.game = game;
    ...
    public void render(float delta) {
        ...
        font.draw(game.getBatch(), "You Win!",2f,9f);
        font.draw(game.getBatch(), "Score = " + this.gameScreen.getScore(),2f,7f);
